  ...
  return (
    <div
      className={`${Header_Classes.header} ${
        activebg && Header_Classes.active
      }`}
    >
      <div className={Header_Classes.toggle_logo}>
        <Link className={Header_Classes.logo} to="/">
          <img src={Logo} alt="Logo" />
        </Link>
        <div
          className={Header_Classes.toggle}
          // onClick={toggleOn}
        >
          <button>
            <svg
      ...
      {/* {Toggle && (
        <div>
          <SideBar />
          <div className={Header_Classes.backdrop} onClick={toggleOn}></div>
        </div>
      )} */}
    </div>
  );
